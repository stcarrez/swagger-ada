...
package body TestAPI.Models is
   ...
   procedure Serialize (Into  : in out Swagger.Streams.Output_Stream'Class;
                        Name  : in String;
                        Value : in Body_2_Type_Vectors.Vector) is
   begin
      Into.Start_Array (Name);
      for Item of Value loop
         Serialize (Into, "", Item);
   ...
   procedure Deserialize (From  : in Swagger.Value_Type;
                          Name  : in String;
                          Value : out Body_2_Type_Vectors.Vector) is
      List : Swagger.Value_Array_Type;
      Item : Body_2_Type;
   begin
      Value.Clear;
   ...
   begin
      ...
      Deserialize (Object, "end_date", Value.End_Date);
      Deserialize (Object, "update_date", Value.Update_Date);
