...
package body TestAPI.Models is
   ...
   begin
      ...
      OpenAPI.Streams.Deserialize (Object, "long_int", Value.Long_Int);
      OpenAPI.Streams.Deserialize (Object, "short_int", Value.Short_Int);
      OpenAPI.Streams.Deserialize (Object, "short_int2", Value.Short_Int_2);
      OpenAPI.Streams.Deserialize (Object, "float_a", Value.Float_A);
      OpenAPI.Streams.Deserialize (Object, "float_b", Value.Float_B);
   end Deserialize;
   ...
   begin
      OpenAPI.Streams.Deserialize (From, Name, Object);
      OpenAPI.Streams.Deserialize (Object, "a", Value.A);
   end Deserialize;
   ...
   begin
      OpenAPI.Streams.Deserialize (From, Name, Object);
      OpenAPI.Streams.Deserialize (Object, "key", Value.Key);
   end Deserialize;
   ...
   begin
      ...
      OpenAPI.Streams.Deserialize (Object, "owner", Value.Owner);
      OpenAPI.Streams.Deserialize (Object, "create_date", Value.Create_Date);
      OpenAPI.Streams.Deserialize (Object, "end_date", Value.End_Date);
      OpenAPI.Streams.Deserialize (Object, "update_date", Value.Update_Date);
