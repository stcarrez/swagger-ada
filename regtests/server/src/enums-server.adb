...
with Enums.Servers;
procedure Enums.Server (Server : in out Servlet.Server.Container'Class) is
   use Util.Properties.Basic;

   CONFIG_PATH : constant String := "enums.properties";

   Port : Natural                          := 8_080;
   App  : aliased OpenAPI.Servers.Applications.Application_Type;
   Log  : constant Util.Log.Loggers.Logger :=
     Util.Log.Loggers.Create ("Enums.Server");
